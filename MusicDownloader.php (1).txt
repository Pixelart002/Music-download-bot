...
// Inline keyboard without "Get Lyrics" button
$keyboard = [
    'inline_keyboard' => [
        [
            [
                'text' => "📢 Updates Channel", 
                'url' => "https://t.me/ouofthebox"
            ]
        ]
    ]
];
...
function downloadSong($spotify_url) {
    $apiResponse = file_get_contents("https://teleservicesapi.vercel.app/spotify?authorization=@Teleservices_Api&spotify_url=" . urlencode($spotify_url));
...
if ($text == "/start") {
    ...
    $welcome_message = "👑 <b>Welcome, Your Majesty!</b> 👑\n\n"
        . "🎶 I'm <@Pulseprofit_botb></b>, your royal assistant for all things music! 🎧\n\n"
        ...
        . "📢 <b>Stay Updated:</b> Don't miss out on the latest features and updates by joining our <a href='https://t.me/ouofthebox'>Updates Channel</a>.\n\n"
        . "💡 <b>Pro Tip:</b> Add me to your groups for shared music fun!\n\n"
        . "🎉 <i>Ready to dive into a world of music? Let’s get started now!</i> 🎤";

    $keyboard = [
        'inline_keyboard' => [
            [['text' => "📢 Updates Channel", 'url' => "https://t.me/ouofthebox"]]
        ]
    ];
    ...
    if ($session_data) {
        ...
        if ($callback_data == "next" && $track_index < count($song_data['tracks']) - 1) {
            ...
            if ($download_link) {
                $caption = "*🎶 Music downloaded by@Pulseprofit_bot 🎵*\n\n_Enjoy your Beats 🎧_";
